...
public class FirebaseMessagingSerializer {
    ...
    static RemoteMessage remoteMessageFromReadableMap(ReadableMap readableMap) {
        ...
        if (readableMap.hasKey(KEY_FROM)) {
            Log.i("react-native-antelop", readableMap.getString(KEY_FROM));
            builder.setFrom(readableMap.getString(KEY_FROM));
        }
