...
/// This method must be called when an Extension starts.
...
///
/// returns:
/// A boolean indicating whether the SDK is Logging or not
...
/// Generic error code reported when Antelop wallet provisioning fails because none of the <code>Product</code> items offered is allowed for the application.
  AntelopErrorNoProductAllowed = 7,
/// Generic error code reported when the activation of the wallet is required
  AntelopErrorActivationRequired = 8,
/// Generic error reported if wallet status is not “connected - ready to use”. Deprecated, use ActivationRequired instead.
  AntelopErrorWalletNotActivated = 9,
/// Generic error code reported when the wallet is deleted.
  AntelopErrorWalletDeleted = 10,
/// Generic error code reported when the wallet is locked thus nothing can be done before an unlock.
  AntelopErrorWalletLocked = 11,
/// Generic error code reported when a management operation fails because the customer has provided wrong credentials when authenticating.
  AntelopErrorCustomerCredentialsInvalid = 12,
/// Requested authentication method is unknown (not recognized)
  AntelopErrorAuthenticationMethodUnknown = 13,
/// Requested authentication method has failed.
  AntelopErrorAuthenticationMethodFailed = 14,
/// Local authentication pattern failed
  AntelopErrorAuthenticationFailed = 15,
/// Strong customer authentication process error code reported when an authentication is refused because it has been cancelled from backend
  AntelopErrorScaCancelledFromBackend = 16,
...
/// Strong customer authentication process error code reported when an authentication is refused because it took too much time to be run
  AntelopErrorScaTimeout = 18,
/// Local authentication pattern internal error
  AntelopErrorAuthenticationInternalError = 19,
...
/// AntelopKeypadView is a subclass of UIView that embeds a digit keyboard below a bullet row indicating how many digit keys have been input. This view can be used when customer is asked to type her/his PIN.
/// It works with a KeypadDelegateProtocol object that allows you to be aware of pin entry events.
/// It can be instantiated via Interface Builder or programmatically via the init function.
/// Init function will simply apply the configuration passed in parameters and set the provided KeypadDelegateProtocol.
/// While when the View is instantiated via Interface Builder, a configuration is built as follows : for each parameter, first the value is retrieved from app’s AntelopKeypadView.plist if provided (see example below), otherwise SDK’s default value is used. Besides, the KeypadDelegateProtocol must then be set programmatically.
/// \code
/// <?xml version="1.0" encoding="UTF-8"?>
/// <!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd">
/// <plist version="1.0">
/// <dict>
///    <key>antelopKeypadViewDefaultShowAlpha</key>
///    <true/>
///    <key>antelopKeypadViewDefaultDeleteButtonIcon</key>
///    <string>antelop_ic_backbutton</string>
///    <key>antelopKeypadViewDefaultColorSecondary</key>
///    <string>antelop_keypadview_colorSecondaryDefault</string>
///    <key>antelopKeypadViewDefaultColorPrimary</key>
///    <string>antelop_keypadview_colorPrimaryDefault</string>
///    <key>antelopKeypadViewDefaultBulletIcon</key>
///    <string>antelop_circle</string>
///    <key>antelopKeypadViewDefaultPinLength</key>
///    <integer>5</integer>
///    <key>antelopKeypadViewDefaultRandomizeKeyboard</key>
///    <true/>
/// </dict>
/// </plist>
///
/// \endcodeOr programmatically:
/// \code
/// let deleteButtonImage = UIImage(systemName: "delete.left"),
/// let extraButtonImage = UIImage(systemName: "xmark")
/// let bulletImage = UIImage(systemName: "staroflife.circle.fill")
/// let view = AntelopKeypadView(randomizeKeyboard: false,
///                              pinNumber: 5,
///                              inputBulletIcon: bulletImage,
///                              colorPrimary: .gray,
///                              colorSecondary: .blue,
///                              deleteButtonImage: deleteButtonImage,
///                              extraButtonImage: extraButtonImage,
///                              showAlpha: true,
///                              keypadDelegate: keypadDelegate)
///
/// \endcode
SWIFT_CLASS("_TtC10AntelopSDK17AntelopKeypadView")
@interface AntelopKeypadView : UIView
- (void)layoutSubviews;
...
/// Devices such as tablets do not have telephony support.
  EligibilityDenialReasonNoTelephony = 7,
};
...
- (BOOL)cancelAndReturnError:(NSError * _Nullable * _Nullable)error;
/// Cancel the process by running online command
- (BOOL)cancelAndReturnError:(NSError * _Nullable * _Nullable)error :(void (^ _Nonnull)(void))completion;
